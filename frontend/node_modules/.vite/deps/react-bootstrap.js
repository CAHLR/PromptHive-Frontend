import {
  ...
  forEach,
  map
} from "./chunk-6G2WVTY5.js";
import {
  Spinner_default
} from "./chunk-MC56NKZX.js";
import {
  DropdownButton_default
} from "./chunk-P34IETFM.js";
import {
...
} from "./chunk-AOVJLIU3.js";
import {
  NavItem_default,
  NavLink_default,
  Nav_default
} from "./chunk-SEK4SKNC.js";
import {
  InputGroup_default
} from "./chunk-NGT24WOO.js";
import "./chunk-YA6MMLR4.js";
import "./chunk-3FZTQG67.js";
import {
  ListGroupItem_default,
  ListGroup_default
} from "./chunk-FZTXNLRO.js";
import {
  require_warning
} from "./chunk-6FNKHQ6P.js";
import {
  TabContext_default
} from "./chunk-3XZNK2XF.js";
import "./chunk-EYJVGHHA.js";
import {
  ModalBody_default,
  ModalDialog_default,
  ModalFooter_default,
...
import {
  ...
  Offcanvas_default
} from "./chunk-5DF7SV3H.js";
import "./chunk-VHVXHYPG.js";
import {
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-PBUWYTSJ.js";
import {
  CloseButton_default,
  Fade_default,
  ...
  useWaitForDOMRef,
  useWillUnmount
} from "./chunk-DOJJTV2Y.js";
import {
  contains
} from "./chunk-HB3FQLD5.js";
import "./chunk-AHEDZNIS.js";
import {
  Row_default
} from "./chunk-D55YTOFB.js";
import {
  Col_default,
  useCol
} from "./chunk-A4ETAKA4.js";
import {
  Button_default
} from "./chunk-ZH3KMLYH.js";
import {
  Container_default
} from "./chunk-ZQPCWEOW.js";
import {
  Collapse_default,
  createChainedFunction_default
} from "./chunk-WMER5JIT.js";
import {
  TransitionWrapper_default,
  safeFindDOMNode,
  transitionEndListener,
  triggerBrowserReflow
} from "./chunk-XOLMRYIY.js";
import {
  listen_default,
  ownerDocument
...
} from "./chunk-XH6EWGQN.js";
import {
  CardImg_default,
  Card_default
} from "./chunk-D3QYIJAS.js";
import "./chunk-L6QP5QYB.js";
import {
  divWithClassName_default
} from "./chunk-2PP6ALLJ.js";
import {
  createWithBsPrefix
} from "./chunk-O6RTHX5X.js";
import "./chunk-4S6YG7XN.js";
import {
  Anchor_default
} from "./chunk-BRA5UM6C.js";
import "./chunk-6EWM2PMP.js";
import {
  useCallbackRef
} from "./chunk-XHICZB6D.js";
import {
...
import {
  ...
  useMounted
} from "./chunk-ZDYRLGQC.js";
import {
  useCommittedRef_default,
  useEventCallback
} from "./chunk-4PT2KTKD.js";
import "./chunk-OU2XQTQY.js";
import {
  Badge_default
} from "./chunk-7JFB3UQZ.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Image = React16.forwardRef(({
  ...
  return (0, import_jsx_runtime17.jsx)("img", {
    ...
    ref,
    ...props,
    className: (0, import_classnames14.default)(className, fluid && `${bsPrefix}-fluid`, rounded && `rounded`, roundedCircle && `rounded-circle`, thumbnail && `${bsPrefix}-thumbnail`)
  });
});
...
var NavDropdown = React18.forwardRef(({
  ...
  return (0, import_jsx_runtime20.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames16.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime19.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime19.jsx)(Dropdown_default.Menu, {
      role: menuRole,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React19.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var Popover = React21.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime22.jsxs)("div", {
    ...
    className: (0, import_classnames17.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime21.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime21.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Overlay2 = React22.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime23.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React22.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames18.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React23.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime26.jsxs)(import_jsx_runtime25.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react13.cloneElement)(children, triggerProps), (0, import_jsx_runtime24.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React24.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime27.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames19.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime28.jsxs)(Component2, {
      className: "page-link",
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime27.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React24.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime28.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React25.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames20.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames21.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React26.forwardRef((props, ref) => {
...
var Placeholder = React27.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime32.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames22.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime32.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var Ratio = React29.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)("div", {
    ...
    className: (0, import_classnames23.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React29.Children.only(children)
  });
});
...
var SplitButton = React30.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  children: [(0, import_jsx_runtime34.jsx)(Button_default, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime34.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime34.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var Stack = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames24.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var TabPanel = React32.forwardRef(
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime37.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime37.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime37.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime37.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  return (0, import_jsx_runtime38.jsx)(TabContext_default.Provider, {
    value: tabContext,
    children: (0, import_jsx_runtime38.jsx)(SelectableContext_default.Provider, {
      value: onSelect || null,
      children
    })
  });
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime39.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React35.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime40.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime40.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime40.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames25.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime44.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime44.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime45.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime44.jsx)(Nav_default, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime44.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime44.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React39.forwardRef((props, ref) => (0, import_jsx_runtime46.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React40.createContext({
...
var ToastHeader = React41.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime48.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames27.default)(bsPrefix, className),
...
var Toast = React42.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime49.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames28.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime49.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime49.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React43.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime50.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames29.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop2 = () => void 0;
var ToggleButton = React44.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime53.jsxs)(import_jsx_runtime52.Fragment, {
    children: [(0, import_jsx_runtime51.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime51.jsx)(Button_default, {
      ...props,
      ref,
      className: (0, import_classnames30.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React45.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime54.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
