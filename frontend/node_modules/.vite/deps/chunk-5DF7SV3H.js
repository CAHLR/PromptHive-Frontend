...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react4.useMemo)(function() {
...
var OffcanvasHeader = React5.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime6.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React6.forwardRef(({
  ...
  const renderBackdrop = (0, import_react5.useCallback)((backdropProps) => (0, import_jsx_runtime6.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime7.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime6.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
//# sourceMappingURL=chunk-5DF7SV3H.js.map
