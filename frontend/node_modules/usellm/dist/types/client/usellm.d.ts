...
import { EditImageOptions, GenerateImageOptions, ImageVariationOptions, LLMCallActionOptions, LLMChatOptions, LLMEmbedOptions, LLMRecordOptions, LLMCallReplicateOptions, LLMCallHuggingFaceOptions, LLMTranscribeOptions, LLMVoiceChatOptions, SpeakOptions, UseLLMOptions } from "./types";
...
export default function useLLM({ serviceUrl: argServiceUrl, fetcher, }?: UseLLMOptions): {
    ...
    callHuggingFace: (options: LLMCallHuggingFaceOptions) => Promise<any>;
};
