...
export declare class LLMService {
    ...
    constructor({ openaiApiKey, elvenLabsApiKey, replicateApiKey, huggingFaceApiKey, fetcher, templates, debug, isAllowed, actions, }: CreateLLMServiceOptions);
    ...
    chat(body: LLMServiceChatOptions): Promise<any>;
    ...
    callHuggingFace(options: LLMServiceCallHuggingFace): Promise<any>;
}
